      ...
      <nav className="navbar navbar-expand-lg navbar-light fixed-top">
        ...
        <div className=" col">
          <form className="d-flex" role="search">
            <input className="form-control me-2 w-50" type="search" aria-label="Search" onChange={(e) => setSearchQuery(e.target.value)}/>
        ...
        <a href='/fav' className="m-3 d-flex justify-content-end col form">Form</a>
